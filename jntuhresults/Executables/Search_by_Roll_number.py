    ...
    def scraping_the_grades(self,code,soup):
        try:
            ...
            for row in table2:
                ...
                try:
                    if(self.deta["Results"][code][subject_code]["subject_grade"]!="F" and self.deta["Results"][code][subject_code]["subject_grade"]!="Ab" and self.deta["Results"][code][subject_code]["subject_grade"]!="-"):
                        continue    
                except:
                    pass
